...
import static eastmeet.backend5.batch.config.SettlementBatchConfig.SETTLEMENT_CHUNK_JOB_NAME;
import static eastmeet.backend5.batch.config.SettlementBatchConfig.SETTLEMENT_JOB_NAME;
...
public class SettlementJobLauncher {
    ...
    public SettlementJobLauncher(
        ...
        @Qualifier(value = SETTLEMENT_JOB_NAME) Job settlementTaskletJob,
        @Qualifier(value = SETTLEMENT_CHUNK_JOB_NAME) Job settlementChunkJob
    ) {
